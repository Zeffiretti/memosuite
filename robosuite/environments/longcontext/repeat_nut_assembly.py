...
class RepeatNutAssembly(ManipulationEnv):
    """
...
class RepeatNutAssemblySingle(RepeatNutAssembly):
    """
...
class RepeatNutAssemblySquare(RepeatNutAssembly):
    """
...
class RepeatNutAssemblyRound(RepeatNutAssembly):
    """
